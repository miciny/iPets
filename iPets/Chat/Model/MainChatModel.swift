...
class MainChatModel: NSObject {
    ...
    init(pic: UIImage, name: String, lable: String, time: Date, view: UIView, nickname: String){
        self.pic = pic
    ...
    convenience init(pic: UIImage, name: String, lable: String, time: Date, nickname: String) {
        let pic = pic
